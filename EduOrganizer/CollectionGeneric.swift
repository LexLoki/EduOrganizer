...
class CollectionGeneric : UIView{
    ...
    init(view: UIView, parent: UIViewController) {
        ...
        collectionView = UICollectionView(frame: CGRectMake(frame.origin.x, frame.origin.y, frame.width, CGRect.getVisibleHeight(frame, vc: parent)), collectionViewLayout: layout);
